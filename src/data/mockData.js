...
// ---------- Phase 9 Item 9: Reflector proposals (pending boss approval) ----------
// One proposal per analyzer type, covering all platforms.
// Format matches proposals.jsonl per phase_9_implementation_plan.md §3 Item 2.
export const MOCK_PROPOSALS = [
  {
    fire_id: "a1b2c3d4-5e6f-7890-abcd-ef1234567890",
    fire_at: hrs(2).toISOString(),
    analyzer: "harvest",
    platform: "facebook",
    proposal_type: "sunset_feed",
    evidence: {
      sample_ids: ["d_ap05", "d_ap06"],
      metrics: {
        engagement_yield_ratio: "0.03",
        publish_count_7d: "5",
    ...
    action: {
      ...
      field: "r/Singularity.enabled",
      current_value: true,
      proposed_value: false,
    },
    boss_attention_required: false,
    hsin_decision: null,
    hsin_decision_at: null,
    hsin_decision_comment: null,
    deployed_at: null,
  },
  {
    fire_id: "b2c3d4e5-6f78-9abc-def0-123456789abc",
    fire_at: hrs(1.5).toISOString(),
    analyzer: "topic",
    platform: "all",
    proposal_type: "adjust_weight",
    evidence: {
      sample_ids: ["d_p01", "d_ap01", "d_ap03"],
      metrics: {
        current_weight: "0.96",
        proposed_weight: "1.18",
        engagement_delta: "+0.22",
        sample_count: "7",
      },
      confidence: "MED",
    },
  ...
  {
    fire_id: "c3d4e5f6-7890-abcd-ef12-3456789abcde",
    fire_at: hrs(1).toISOString(),
    analyzer: "scorer",
    platform: "threads",
    proposal_type: "tune_threshold",
    evidence: {
      sample_ids: ["d_ap02", "d_ap04"],
      metrics: {
  ...
  {
    fire_id: "d4e5f6a7-8901-bcde-f123-456789abcdef",
    fire_at: hrs(0.5).toISOString(),
    analyzer: "composer",
    platform: "instagram",
    proposal_type: "add_rule",
    evidence: {
      sample_ids: ["d_ap01", "d_ap06"],
      metrics: {
        top_quartile_trait: "opening with number/statistic",
        bot_quartile_trait: "abstract concept",
        engagement_lift: "+34%",
      },
      confidence: "MED",
    },
    action: {
      target_config: "config/platforms/ig_v2.md",
      field: "body_rules",
      current_value: null,
      proposed_value: "WHEN post opens with specific number/data → engagement +34% on IG",
    },
    boss_attention_required: false,
    hsin_decision: null,
    hsin_decision_at: null,
  ...
  {
    fire_id: "e5f6a7b8-9012-cdef-0123-456789abcdef0",
    fire_at: hrs(0.25).toISOString(),
    analyzer: "gate",
    platform: "all",
    ...
    evidence: {
      sample_ids: [],
      metrics: {
        emergency_publish_rate_14d: "12.3%",
        target_rate: "10%",
        silence_breach_count: "3",
      },
      confidence: "MED",
    },
    action: {
      target_config: "gate.yaml",
      field: "max_silence_hours",
      current_value: 4,
      proposed_value: 5,
    },
    boss_attention_required: false,
  ...
  {
    fire_id: "f6a7b8c9-0123-def0-1234-56789abcdef01",
    fire_at: hrs(0.1).toISOString(),
    analyzer: "harvest",
    platform: "all",
    proposal_type: "sunset_feed",
    evidence: {
      ...
      metrics: {
        ...
        publish_count_7d: "3",
        days_since_creation: "42",
      },
      confidence: "HIGH",
    },
    action: {
      target_config: "feeds.yml",
      field: "DigiTimes.enabled",
      current_value: true,
      proposed_value: false,
    },
    boss_attention_required: true,
  ...
  {
    fire_id: "a7b8c9d0-1234-ef01-2345-6789abcdef012",
    fire_at: hrs(-0.5).toISOString(),
    analyzer: "topic",
    platform: "facebook",
    proposal_type: "adjust_weight",
    evidence: {
      ...
      metrics: {
        current_weight: "1.52",
        proposed_weight: "1.35",
        engagement_delta: "-0.17",
      },
      confidence: "LOW",
    },
    action: {
  ...
  {
    fire_id: "b8c9d0e1-2345-f012-3456-789abcdef0123",
    fire_at: hrs(-1).toISOString(),
    analyzer: "scorer",
    platform: "facebook",
    proposal_type: "tune_threshold",
    evidence: {
      ...
      metrics: {
        ...
        proposed_threshold: "0.67",
        engagement_per_published: "+5%",
      },
      confidence: "MED",
    },
    action: {
      target_config: "thresholds.yml",
      field: "facebook.RESCUE_PUBLISH",
      current_value: 0.65,
      proposed_value: 0.67,
    },
    boss_attention_required: false,
